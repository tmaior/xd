...
from adcubum.data_processing import preprocess_data
from syntheticus.data_processing import track_data
from syntheticus.model_training import train
from adcubum.data_processing import postprocess_data
...
dag = DAG(
    ...
    description='Synthetcus Hub use case Adcubum relational and bi-temporal dataset',
...
with dag:
    ...
    data_postprocess = PythonOperator( 
        provide_context=True, 
    ...
    data_ingestion >> data_preprocess >> data_track >> model_training >> model_track >> model_sampling >> data_postprocess >> data_synth_track