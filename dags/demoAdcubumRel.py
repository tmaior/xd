...
with dag:
    ...
    data_ingestion >> data_preprocess >> data_track >> model_training >> model_track >>model_sampling >> ensure_ref_int >> data_postprocess >> data_synth_track >> model_metrics >> report_track